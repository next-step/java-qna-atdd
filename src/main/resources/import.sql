...
INSERT INTO user (id, user_id, password, name, email, created_at) values (3, 'ninezero90hy', 'ninezero90hy@', '나인제로', 'ninezero90hy@gmail.com', CURRENT_TIMESTAMP());
...
INSERT INTO question (id, writer_id, title, contents, created_at, deleted) VALUES (3, 3, 'Clean Code', ' 동료들과 힘을 모아 ‘개발하며’ 클린 코드를 만드는 최상의 애자일 기법을 소개하고 있다. 소프트웨어 장인 정신의 가치를 심어 주며 프로그래밍 실력을 높여줄 것이다. 여러분이 노력만 한다면. 어떤 노력이 필요하냐고? 코드를 읽어야 한다', CURRENT_TIMESTAMP(), false);
