...
INSERT INTO user (id, user_id, password, name, email, created_at) values (3, '2cycle', 'test', '이순환', '2cycle@slipp.net', CURRENT_TIMESTAMP());
...
INSERT INTO question (id, writer_id, title, contents, created_at, deleted) VALUES (3, 1, 'testQ', "testQ" , CURRENT_TIMESTAMP(), false);

INSERT INTO answer (writer_id, contents, created_at, question_id, deleted) VALUES (1, 'testA', CURRENT_TIMESTAMP(), 1, false);
