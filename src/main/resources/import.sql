...
INSERT INTO user (id, user_id, password, name, email, created_at) values (3, 'testid', 'test', 'testname', 'test@t.t', CURRENT_TIMESTAMP());
...
INSERT INTO answer (writer_id, contents, created_at, question_id, deleted) VALUES (3, 'javajigi가 쓴 글 1번글의 댓글', CURRENT_TIMESTAMP(), 1, false);
...
INSERT INTO question (id, writer_id, title, contents, created_at, deleted) VALUES (3, 3, 'test제목', 'test본문', CURRENT_TIMESTAMP(), false);

INSERT INTO question (id, writer_id, title, contents, created_at, deleted) VALUES (4, 1, 'javajigi question 제목', 'test본문', CURRENT_TIMESTAMP(), false);


INSERT INTO answer (writer_id, contents, created_at, question_id, deleted) VALUES (3, 'test댓글입니다.', CURRENT_TIMESTAMP(), 1, false);
