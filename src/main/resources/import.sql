...
INSERT INTO question (id, writer_id, title, contents, created_at, deleted) VALUES (3, 1, 'TDD를 잘 하는 방법이 있을까요?', '테스트할 수 있는 부분과 테스트할 수 없는 부분을 분리해보세요', CURRENT_TIMESTAMP(), false);