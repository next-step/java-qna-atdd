...
public class QuestionTest extends BaseTest {
    ...
    public static final Question QUESTION_2 = new Question(2L,"runtime 에 reflect 발동 주체 객체가 뭔지 알 방법이 있을까요?"
            ...
            ,UserTest.SANJIGI, new Answers()
    );

    public static final Question QUESTION_3 = new Question(3L,"3333333"
            , "33답변입니다"
            ,UserTest.JAVAJIGI, new Answers()
    );

    public static final Question QUESTION_4 = new Question(4L,"34444든 이유는 뭘까?"
            , "444퀘스쳔"
            ,UserTest.JAVAJIGI, new Answers()
    );

    public static final Question QUESTION_5 = new Question(4L,"55555"
            , "5555555555"
            ,UserTest.JAVAJIGI, new Answers()
    );
    ...
    public void delete_succes_has_not_answer() throws CannotDeleteException {
        ...
        Question question = new Question("신규타이틀", "내용내용내용", loginUser, new Answers());
