...
public class QuestionAcceptanceTest extends AcceptanceTest {
    ...
    public void update_no_owner() {
        ResponseEntity<String> response = update(basicAuthTemplate(newUser("testUser")));
    ...
    private ResponseEntity<String> update(TestRestTemplate template) {
        ...
        return template.postForEntity(String.format("/questions/%d", 1), htmlFormData.newHttpEntity(), String.class);
    }
    ...
    private ResponseEntity<String> delete(TestRestTemplate template) {
        ...
        return template
                .postForEntity(String.format("/questions/%d", 2), htmlFormData.newHttpEntity(), String.class);
    }
}
